pipeline {
  ...
  environment {
    ...
    EXT_USER = 'zen-browser'
    EXT_REPO = 'desktop'
    BUILD_VERSION_ARG = 'ZEN_VERSION'
    LS_USER = 'linuxserver'
    LS_REPO = 'docker-zen'
    CONTAINER_NAME = 'zen'
    DOCKERHUB_IMAGE = 'linuxserver/zen'
    DEV_DOCKERHUB_IMAGE = 'lsiodev/zen'
    PR_DOCKERHUB_IMAGE = 'lspipepr/zen'
    DIST_IMAGE = 'debian'
    MULTIARCH = 'true'
    CI = 'true'
    CI_WEB = 'true'
    ...
    stage('Build-Single') {
      ...
      steps {
        ...
        sh "docker buildx build \
          ...
          --label \"org.opencontainers.image.url=https://github.com/linuxserver/docker-zen/packages\" \
          --label \"org.opencontainers.image.documentation=https://docs.linuxserver.io/images/docker-zen\" \
          --label \"org.opencontainers.image.source=https://github.com/linuxserver/docker-zen\" \
          --label \"org.opencontainers.image.version=${EXT_RELEASE_CLEAN}-ls${LS_TAG_NUMBER}\" \
          --label \"org.opencontainers.image.revision=${COMMIT_SHA}\" \
          --label \"org.opencontainers.image.vendor=linuxserver.io\" \
          --label \"org.opencontainers.image.licenses=GPL-3.0-only\" \
          --label \"org.opencontainers.image.ref.name=${COMMIT_SHA}\" \
          --label \"org.opencontainers.image.title=Zen\" \
          --label \"org.opencontainers.image.description=[Zen Browser](https://zen-browser.app/) is a free and open-source fork of Mozilla Firefox with a focus on privacy, customizability and design.\" \
